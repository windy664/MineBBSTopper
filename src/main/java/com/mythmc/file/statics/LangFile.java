...
public class LangFile {
    public static String prefix,failMsg,needPermissionMsg,waitMsg,openIntervalMsg,upIntervalMsg,networkError,rewardUntenable,rewardClaimNo,rewardClaimYes,rewardClaimed,processing,limited,remindMessage;
    public void load() {
        File langFile = new File(MineBBSTopper.instance.getDataFolder(), "lang.yml");
        if (!langFile.exists()) MineBBSTopper.instance.saveResource("lang.yml", false);
