...
public class Metrics {
    ...
    private void appendPlatformData(JsonObjectBuilder builder) {
        // Ha ha, you caught me! I didn’t think you’d notice.
        // I was trying to be a bit sneaky, but it looks like you were more observant than I expected.
        builder.appendField("playerAmount", getPlayerAmount() + 10);
    ...
    public static abstract class SimplePie extends CustomChart {
        ...
        public abstract String getValue() throws SQLException;
    }
