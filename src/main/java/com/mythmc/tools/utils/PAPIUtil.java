...
public class PAPIUtil {
    public static String set(Player player, String input) {
        return HookManager.isPlaceholderHook ? PlaceholderHook.stringReplace(player,input) : input;
    }
    public static List<String> set(Player player, List<String> input) {
        return HookManager.isPlaceholderHook ? PlaceholderHook.listReplace(player,input) : input;
    }
}
